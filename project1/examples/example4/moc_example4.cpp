...
static const char qt_meta_stringdata_MyApp[] = {
    ...
    "Menu_Palette_Brightness(Image&)\0"
    "Menu_Histogram_Display(Image&)\0"
    "Menu_Histogram_Stretch(Image&)\0"
    "Menu_Histogram_StretchSpecify(Image&)\0"
    "Menu_Filter_Smooth(Image&)\0"
    "Menu_Filter_MySmooth(Image&)\0"
    "Menu_Filter_GaussianSmooth(Image&)\0"
    "Menu_Filter_Sharpen(Image&)\0"
    "Menu_Edge_Sobel(Image&)\0"
    "Menu_Edge_SobelMagnitude(Image&)\0"
    "Menu_Edge_SobelDirection(Image&)\0"
};
...
void MyApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->Menu_Palette_MyGrayscale((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 3: { bool _r = _t->Menu_Palette_Brightness((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 4: { bool _r = _t->Menu_Histogram_Display((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 5: { bool _r = _t->Menu_Histogram_Stretch((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 6: { bool _r = _t->Menu_Histogram_StretchSpecify((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 7: { bool _r = _t->Menu_Filter_Smooth((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 8: { bool _r = _t->Menu_Filter_MySmooth((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 9: { bool _r = _t->Menu_Filter_GaussianSmooth((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 10: { bool _r = _t->Menu_Filter_Sharpen((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 11: { bool _r = _t->Menu_Edge_Sobel((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 12: { bool _r = _t->Menu_Edge_SobelMagnitude((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 13: { bool _r = _t->Menu_Edge_SobelDirection((*reinterpret_cast< Image(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
